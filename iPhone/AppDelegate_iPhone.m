...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    //self.viewController = [[SelectionFirstViewController alloc] initWithNibName:nil bundle:nil];
    //self.viewController = [[MessageViewController alloc] initWithNibName:nil bundle:nil];
    self.viewController = [[TitleViewController alloc] initWithNibName:nil bundle:nil];
